...
$arsip = mysqli_query($koneksi, "SELECT * FROM tb_arsip WHERE jenis='Aktif'");
...
<head>
    ...
    <title>PRINT DATA ARSIP AKTIF</title>
</head>
<body>
<table style="border: 1px solid #fff; width: 100%;">
        <tr>
            <td style="width: 15%;">
                <img src="../../dist/img/bpkp.png" style="width:90px; height:90px;"> 
            </td>
            <td style="width:77%;">
                <center>
