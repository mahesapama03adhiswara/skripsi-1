...
AND tb_peminjaman.status='DITERIMA'
AND YEAR(tgl_pinjam)='$tahun' 
AND MONTH(tgl_pinjam)='$bulan1'");

while ($data=$sql->fetch_assoc()) {
?>
   <h3><center><b>LAPORAN DATA PEMINJAMAN ARSIP INAKTIF BIDANG"<?php echo $data['nama_bidang'] ?>" </b></center></h3> 
   <?php
break;
}
   ?>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">No. Pinjam</th>
