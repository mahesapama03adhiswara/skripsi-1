...
$sql= mysqli_query($koneksi,"SELECT * FROM tb_mutasi, tb_arsip, tb_bidang, tb_pengguna
...
AND tb_mutasi.validasi='DITERIMA'
AND YEAR(tgl_ajukan)='$tahun'
AND MONTH(tgl_ajukan)='$bulan1'");

while ($data=$sql->fetch_assoc()) {
?>
   <h3><center><b>LAPORAN DATA MUTASI ARSIP BIDANG"<?php echo $data['nama_bidang'] ?>" </b></center></h3> 
   <?php
break;
}
   ?>
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">No. Mutasi</th>
   <th width="25px" height="50px">Nama Pengaju</th>
   ...
   <th width="25px" height="50px">Lokasi</th> -->
    ...
    <tbody>
        <?php
        $no = 1;
        $sql = $koneksi ->query("SELECT * FROM tb_mutasi, tb_arsip, tb_bidang, tb_pengguna
        WHERE tb_mutasi.id_arsip =tb_arsip.id_arsip
        AND tb_mutasi.bidang = tb_bidang.id_bidang
        AND tb_bidang.id_bidang = '$id_bidang'
        AND tb_mutasi.nip = tb_pengguna.nip
        ...
        ?>
          <tr>
            ...
            <td width="100px" height="50px"><center><?php echo $data['id_mutasi'];?></center></td>
            ...
            <td width="100px" height="50px"><center><?php echo $data['tgl_ajukan'];?> </center></td>   
            <td width="100px" height="50px"><center><?php echo $data['validasi'];?> </center></td> 
