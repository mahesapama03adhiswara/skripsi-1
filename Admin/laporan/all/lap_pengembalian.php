       ...
       // $id_arsip=$_POST['id_arsip'];
        ...
        <!-- <tr>
           ...
           <td  width="100px" height="50px"><center> Rp.<?php echo number_format($data2['total_harga']);?></center></td>
            ...
            &nbsp&nbsp&nbsp
            <p align="right">Khaerus Shaleh &nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp</p>&nbsp&nbsp&nbsp&nbsp&nbsp</p>
            <!-- <p align="right">NIP. 197612509 198012 4 002</p> -->
            </div>
            <!-- <p align="right"> NIP. 197612509 198012 4 002 &nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp</p> -->
            <br></br>
