...
?>
   <h3><center><b>LAPORAN DATA ARSIP INAKTIF </b></center></h3> 
   <?php
break;
}
   ?>
...
<table border="1" width="100%" style="border-collapse: collapse;" align="center">
    ...
    <thead>
        <tr align="center" >
            ...
            <th width="25px" height="50px"><center>No. ST</center> </th>
       ...
       // $id_arsip=$_POST['id_arsip'];
        ...
        ?>
          <tr>
            ...
            <td width="100px" height="80px"><center><?php echo $data['nama_arsip'];?></center></td>
