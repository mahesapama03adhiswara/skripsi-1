            ...
            <div class="card-body">
                ...
                <div class="table table-borderless">
                    <table class="table table-borderless" style="width: 150%">
                        ...
                        <center>
                            <h3 style="color:black ;">BERITA ACARA PINJAM ARSIP INAKTIF</h3>
                        </center>
                        <!-- <center>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>Perihal</td>
                                            <td>&emsp;:&nbsp;</td>
                                            <td>Peminjaman Arsip Inaktif</td>
                                        </tr>
                                    </table>
                                    </p>
                                    <br>
                                
                                    <p>Pada tanggal <?php echo tgl_indo($data['tgl_pinjam']) ?>, yang bertanda tangan dibawah ini :</p>
                                    ...
                                    <br>
                                    <p>Mengajukan Peminjaman Arsip Inaktif dengan keterangan seperti berikut :</p>
                                    ...
                                    <br>
                                    <p>Maka dari itu, pegawai dari <?php echo $data['nama_bidang']; ?> atas nama <?php echo $data['nama_pegawai']; ?> dapat mengambil arsip yang di inginkan.</p>
                                     <?php }  ?>
