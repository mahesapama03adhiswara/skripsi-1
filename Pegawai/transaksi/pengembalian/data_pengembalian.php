                ...
                ?>
						...
						<tr>
							...
							<td>
								...
								<a href="?page=kembali&kode=<?php echo $data['id_peminjaman']; $data['id_peminjaman']; ?> &kode_klasifikasi_=<?php echo $data['kode_klasifikasi']; ?> &nip=<?php echo $data['nip']; ?> &jumlah=<?php echo $data['jumlah']; ?> &tgl_pinjam=<?php echo $data['tgl_pinjam']; ?>"  title="Setujui" class="btn btn-danger">
